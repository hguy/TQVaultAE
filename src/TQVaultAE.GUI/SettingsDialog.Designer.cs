...
namespace TQVaultAE.GUI
{
	...
	internal partial class SettingsDialog
	{
		...
		private void InitializeComponent()
		{
            ...
            this.allowItemEditCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.allowItemCopyCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.skipTitleCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.loadLastCharacterCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.loadLastVaultCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.vaultPathTextBox = new TQVaultAE.GUI.Components.UI.ScalingTextBox();
            this.vaultPathLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.cancelButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.okayButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.folderBrowserDialog = new System.Windows.Forms.FolderBrowserDialog();
            this.resetButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.vaultPathBrowseButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.toolTip = new System.Windows.Forms.ToolTip(this.components);
            this.enableCustomMapsCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.loadAllFilesCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.suppressWarningsCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.playerReadonlyCheckbox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.characterEditCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.EnableDetailedTooltipViewCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.ItemBGColorOpacityLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.EnableCharacterRequierementBGColorCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.languageComboBox = new TQVaultAE.GUI.Components.UI.ScalingComboBox();
            this.languageLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.detectLanguageCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.titanQuestPathTextBox = new TQVaultAE.GUI.Components.UI.ScalingTextBox();
            this.titanQuestPathLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.immortalThronePathLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.immortalThronePathTextBox = new TQVaultAE.GUI.Components.UI.ScalingTextBox();
            this.detectGamePathsCheckBox = new TQVaultAE.GUI.Components.UI.ScalingCheckBox();
            this.titanQuestPathBrowseButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.immortalThronePathBrowseButton = new TQVaultAE.GUI.Components.UI.ScalingButton();
            this.customMapLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.mapListComboBox = new TQVaultAE.GUI.Components.UI.ScalingComboBox();
            this.baseFontLabel = new TQVaultAE.GUI.Components.UI.ScalingLabel();
            this.baseFontComboBox = new TQVaultAE.GUI.Components.UI.ScalingComboBox();
